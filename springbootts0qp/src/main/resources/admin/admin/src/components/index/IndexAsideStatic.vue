		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"transparent"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"width":"calc(100% - 34px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>首页</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"width":"calc(100% - 34px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						...
						<span :style='{"width":"calc(100% - 34px)","verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>{{ menu.menu }}</span>
					</template>
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #777;
				  				  white-space: nowrap;
				  				  background: #C0D9D9 center center no-repeat;
				  				  display: flex;
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #000;
						background: url(http://codegen.caihongy.cn/20220727/58b3ef930ee94a29865a959bbec2ae0a.png) center center no-repeat;
					}
		...
		.el-menu-vertical-demo .el-submenu /deep/ .el-menu .el-menu-item:hover {
						padding: 0 40px;
						color: #fff;
						background: linear-gradient(180deg, #CDA14C 0%, #FAE6B8 100%);
						line-height: 50px;
						height: 50px;
					}
